...
# Makefile for TestSGX - Coding with SGX
##################################
...
App_Cpp_Files := App/myApp.cpp App/PasswordManagerCore.cpp App/VaultFile.cpp App/EnclaveBridge.cpp $(wildcard App/Edger8rSyntax/*.cpp) $(wildcard App/TrustedLibrary/*.cpp)
...
Enclave_Cpp_Files := Enclave/Enclave.cpp Enclave/E_Vault.cpp $(wildcard Enclave/Edger8rSyntax/*.cpp) $(wildcard Enclave/TrustedLibrary/*.cpp)
